...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#808080;color:#FFFFFF;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #1fa3ec}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:340px}"
// links
